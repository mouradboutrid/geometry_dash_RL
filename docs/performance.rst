...
+========================+===========+==========+===============+
| Random Actions         | 100000+   | 200+ hrs | <1%           |
+------------------------+-----------+----------+---------------+
| Simple Q-Learning      | Fails     | N/A      | N/A (tabular) |
+------------------------+-----------+----------+---------------+
| DQN (Standard)         |     -     | 72 hrs   |       -       |
+------------------------+-----------+----------+---------------+
| **Double DQN** ✓       | **15k**   | 24 hrs   | **72%**       |
+------------------------+-----------+----------+---------------+
| PPO                    |     -     |    -     |       -       |
+------------------------+-----------+----------+---------------+
| A3C (4 workers)        |     -     |    -     |       -       |
...
.. code-block:: text
   ...
   ──────────────────────┼───────────────────────┼──────────
   Without Curriculum    | Never(>200000 minimum)| >400%
